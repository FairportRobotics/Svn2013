/*
 * Purpose:  Allows the camera image to appear on the dashboard
*/
...
/**
 * This is a "depreciated" version of the Target class used with this 2010 custom vision code. DO NOT USE. -Patrick Cipolla
 * @author dtjones
 */
public class TargetDontUse {
    ...
    TargetDontUse(ParticleAnalysisReport firstParticle, ParticleAnalysisReport secondParticle) {
     ...
     */
    public static TargetDontUse getTarget(ColorImage image, Position position,
                    ...
                    case Position.above_val:
                        if (secondTrackReport.center_mass_y < firstTrackReport.center_mass_y) {
                            ...
                            if (aligned(firstTrackReport.center_mass_x,
                                ...
                                return new TargetDontUse(firstTrackReport, secondTrackReport);
                            }
                        }
                        break;
