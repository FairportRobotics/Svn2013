 ...
 * 
 */
public class SetBoomSetpoint extends CommandBase {
    
    private double setpoint;
    
    public SetBoomSetpoint(double setpoint) {
    ...
    // wrist movement should stop when wrist is close (.08) to setpoint
        return Math.abs(boom.getPosition() - setpoint) < .08;
    }
